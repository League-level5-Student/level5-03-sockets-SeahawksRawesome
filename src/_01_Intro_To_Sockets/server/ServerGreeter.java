...
public class ServerGreeter extends Thread {
	...
	public ServerGreeter() throws IOException {
		...
		serverSockt = new ServerSocket(8080);
	...
	public void run() {
		...
		while (switches) {
			...
			try {
				...
				// expires.
				Socket sockobj = serverSockt.accept();
				...
				DataInputStream streamed = (DataInputStream) sockobj.getInputStream();
				...
				DataOutputStream streams = (DataOutputStream) sockobj.getOutputStream();
				// 14. Use the DataOutputStream object to send a message to the client using the
				// writeUTF(String message) method.
				streams.writeUTF("hello client this is your captain speaking");
